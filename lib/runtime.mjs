...
// The --config for a gateway that a hook starts. spawn() turns null into "null", a path relative to the project the
// hook runs in, so no resolved path means no flag: the gateway then resolves the same way the hook did.
export function configArgs(configPath) {
