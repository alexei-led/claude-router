...
// The history the gateway saw is gone: a compaction or a rewind. The cached prefixes and the context size are
// unknown, and the votes and the escalation hold were about turns that are no longer in it. The route stays until
// the next decision.
function restartHistory(memory) {
  memory.models = {};
  memory.lastRequest = null;
